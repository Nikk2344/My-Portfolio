...
const projects = [
  {
    ...
    icon: '🏫',
    description: 'A fully functional ERP system built for academic institutions to manage students, courses, and performance.',
  },
  {
    title: 'OpenVPN User Manager',
    icon: '🔒',
    description: 'A VPN tunnel-based system with UI that lets admins manage users and sync them with OpenVPN securely.',
  },
  {
    title: 'Spotify Clone',
    icon: '🎵',
    description: 'A React & Tailwind-based music UI with search, playlists, and mobile responsiveness.',
  },
];
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-lime-400 mb-12">Featured Projects</h2>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((proj, idx) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-lime-300 mb-2">{proj.title}</h3>
